...
def transition_model(corpus, page, damping_factor):
    ...
    for p in corpus:
        pdist[p] = (1 - damping_factor)/len(corpus)

    if corpus[page]:
        for link in corpus[page]:
            pdist[link] += damping_factor/len(corpus[page])
    else:
        for link in corpus[page]:
            pdist[link] = 1/len(corpus)
        ...
        for page in corpus:
            ...
            for other_page in corpus:
                ...
                if not corpus[other_page]:
                    new_rank += damping_factor * ranks[other_page] / len(corpus)
